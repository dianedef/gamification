...
`);
  ...
  function N(e, r) {
    ...
    function f(c, g, p) {
      for (var y = v(c, "particleCount", G), w = v(c, "angle", Number), C = v(c, "spread", Number), b = v(c, "startVelocity", Number), cr = v(c, "decay", Number), hr = v(c, "gravity", Number), ur = v(c, "drift", Number), j = v(c, "colors", K), dr = v(c, "ticks", Number), D = v(c, "shapes"), fr = v(c, "scalar"), vr = !!v(c, "flat"), U = X(c), z = y, O = [], mr = e.width * U.x, gr = e.height * U.y; z--; )
        O.push(
          nr({
            x: mr,
            y: gr,
