# 00 — Prompts pour utiliser cette base de connaissances

> Des prompts prêts à l'emploi pour tirer le maximum de cette base de connaissances avec un LLM (Claude, GPT, etc.).

---

## Comment utiliser ce document

1. **Copier le prompt** qui correspond à votre besoin
2. **Donner au LLM accès** à la base de connaissances (en contexte, en RAG, ou en référence)
3. **Adapter** les parties entre `[crochets]` à votre situation
