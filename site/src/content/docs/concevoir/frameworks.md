---
title: "Frameworks de gamification"
description: "Les modèles structurés pour concevoir, analyser et implémenter la gamification de façon systématique."
pubDate: "2026-03-21"
section: "concevoir"
order: 3
---
...
Pour analyser ton produit, évalue chaque Core Drive de 0 à 10 :
...
**Utilise plusieurs frameworks ensemble** :
1. **Octalysis** pour l'analyse et le scoring de ta gamification
2. **Hexad** pour comprendre tes types d'utilisateurs
